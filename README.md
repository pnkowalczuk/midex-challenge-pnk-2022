...
* there is a potential infinite loop problem in `ReportingStructureServiceImpl.java`. Theoretically it should be impossible, as no one should be reporting to the people to whom their subordinates are reporting. Nonetheless it is programatically possible. If I were more worried about it I probably would have started with a hashset instead of converting to one at the end. I've indicated the potentially problematic lines with comments in the file.
